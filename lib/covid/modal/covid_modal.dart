...
List<CovidModal> covidModalFromJson(String str) => List<CovidModal>.from(json.decode(str).map((x) => CovidModal.fromJson(x)));

String covidModalToJson(List<CovidModal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
